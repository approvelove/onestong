...
#define heimargin       1
//原来是20.0f
#define marginFrame     15.0f
//原来是16.f
#define labelFontSize       12.f

#define labelOffset     10.0f

static const CGFloat kPadding = 4.f;
static const CGFloat kLabelFontSize = labelFontSize;
...
- (void)layoutSubviews {
	...
	indicatorF.size.width = MIN(indicatorF.size.width-10, maxWidth);
    ...
    if ([[UIDevice currentDevice].systemVersion floatValue] >= 5.0) {
        ...
        indicatorFrame = CGRectMake(indicatorF.origin.x, indicatorF.origin.y, indicatorF.size.width, indicatorF.size.height);
        
    }
    else {
       
        indicatorFrame = CGRectMake(indicatorF.origin.x + 2, indicatorF.origin.y + 2, indicatorF.size.width - 5, indicatorF.size.height - 15);
	...
	CGRect labelF;
     //modify bu yiyun.liu
    if ([[UIDevice currentDevice].systemVersion floatValue] >= 5.0) {
        labelF.origin.y = yPos - labelOffset + 12;
    }
    else {
        labelF.origin.y = yPos - labelOffset - 2;
    }	
    //end
